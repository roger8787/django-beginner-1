...
class ReservationForm(forms.ModelForm):
    class Meta:
        ...
        widgets={
            'reservation_code':forms.TextInput(attrs={'placeholder':'Ingresa tu codigo de asistencia', 'class':'form-control bg-secondary border-0 py-4 px-3'}), 
            ...
            'will_assist':forms.Select(choices=((True,'Si'), (False,'No')), attrs={'class':'form-control bg-secondary border-0 py-2 px-3'}),
...
class NumberReservation(forms.ModelForm):
    class Meta:
        ...
        widgets={
            'num_will_assist':forms.NumberInput(attrs={'class':'form-control bg-secondary border-0 ', 'placeholder':'Ingresa cantidad de asistencias'}),
